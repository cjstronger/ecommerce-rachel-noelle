...
export const FreeConsultation = ({ firstName }) => {
  return (
    <Html>
      <Tailwind>
        <Head>
        ...
        <Preview>Rachel's Free Consultation</Preview>
          ...
          <Container>
            ...
            <Section className="p-5">
              ...
              <Text className="text-lg">
                Thank you for your interest in my free consultation call, I will
                get with you shortly.
              </Text>
