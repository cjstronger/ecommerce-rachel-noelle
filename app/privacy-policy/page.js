export default function Page() {
  return (
    <div className="mt-[5rem] mx-5">
      ...
      <h2 className="text-2xl mt-5">Interpretation and Definitions</h2>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Rachel Noelle.
          </p>
          <p>
        ...
        <li>
          <p>
            ...
            natural person who is a California resident. A resident, as defined
            in the law, includes (1) every individual who is in the USA for
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Rachel Noelle, accessible from{" "}
            <a
              className="underline text-"
              href="https://www.rachelnoelle.net"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.rachelnoelle.net
            </a>
          </p>
        </li>
        <li>
      ...
      <hr className=" mt-5 w-full h-[2px] bg-fadedBlack fill-fadedBlack border-fadedBlack"></hr>
      <h2 className="text-2xl mt-5">Collecting and Using Your Personal Data</h2>
      ...
      <hr className=" mt-5 w-full h-[2px] bg-fadedBlack fill-fadedBlack border-fadedBlack"></hr>
      <h2 className="text-2xl mt-5">GDPR Privacy</h2>
      ...
      <h3 className="text-xl">Your Rights under the GDPR</h3>
      <p>
      ...
      <hr className=" mt-5 w-full h-[2px] bg-fadedBlack fill-fadedBlack border-fadedBlack"></hr>
      <h2 className="text-2xl mt-5">CCPA/CPRA Privacy Notice</h2>
      <p>
      ...
      <h3 className="text-xl">Categories of Personal Information Collected</h3>
      <p>
      ...
      <h3 className="text-xl">Sources of Personal Information</h3>
      <p>
      ...
      <h3 className="text-xl">Use of Personal Information</h3>
      <p>
      ...
      <h3 className="text-xl">Disclosure of Personal Information</h3>
      <p>
      ...
      <h3 className="text-xl">Share of Personal Information</h3>
      <p>
      ...
      <h3 className="text-xl">Sale of Personal Information</h3>
      <p>
      ...
      <h3 className="text-xl">Your Rights under the CCPA/CPRA</h3>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          Disclosure of My Sensitive Personal Information&quot; section or
          contact Us.
        </li>
        <li>
      ...
      <ul>
        <li>By email: rachelnoellesart@gmail.com</li>
      </ul>
      <p>
      ...
      <h3 className="text-xl">Do Not Sell My Personal Information</h3>
      <p>
        As defined in the CCPA/CPRA, &quot;sell&quot; and &quot;sale&quot; mean
        selling, renting, releasing, disclosing, disseminating, making
        available, transferring, or otherwise communicating orally, in writing,
      ...
      <hr className=" mt-5 w-full h-[2px] bg-fadedBlack fill-fadedBlack border-fadedBlack"></hr>
      <h2 className="text-2xl mt-5">Links to Other Websites</h2>
      <p>
      ...
      <hr className=" mt-5 w-full h-[2px] bg-fadedBlack fill-fadedBlack border-fadedBlack"></hr>
      <h2 className="text-2xl mt-5">Changes to this Privacy Policy</h2>
      <p>
      ...
      <ul>
        <li className="text-xl">By email: rachelnoellesart@gmail.com</li>
      </ul>
    </div>
  );
}
