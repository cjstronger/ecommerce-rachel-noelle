...
export default function CoachingDetails() {
  return (
    <>
      ...
      <div className="grid grid-cols-2 lg:mx-[10rem]">
        <GridCol
          colSpan="1"
          bg="fadedBlack"
          shadow="xl"
          ...
          textColor="primary"
        >
          <h1 className="text-center text-md">Phase 4</h1>
          <p className="lg:text-5xl text-center">Conviction</p>
        </GridCol>
        <GridCol colSpan="1" bg="accent" shadow="xl" z="10">
          <h1 className="text-center text-md">Phase 5</h1>
